...
function createWallet() {
    return __awaiter(this, void 0, void 0, function () {
        var arweave, key, address, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    key = _a.sent();
                    // Anahtarı JSON dosyasına kaydet
                ...
                case 2:
                    ...
                    return [2 /*return*/, { key: key, address: address }];
                case 3:
                    error_1 = _a.sent();
...
createWallet()
    .then(function () { return console.log('Wallet creation complete!'); })
    .catch(console.error);
